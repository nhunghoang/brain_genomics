...
##FID - indepdent runs (now an argument in the pool function) 
...
split_file = '/data1/rubinov_lab/brain_genomics/analyses_HCP/DATA_OUTPUT/train_test_assoc_split.hdf5'
