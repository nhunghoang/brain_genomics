...
out_path = '/data1/rubinov_lab/brain_genomics/analyses_HCP/interReg_overlap'
png_path = '/data1/rubinov_lab/brain_genomics/analyses_HCP/interReg_overlap/regphen_correlations.png'
...
for phen in phens: 
    phen_path = '/data1/rubinov_lab/brain_genomics/analyses_HCP/DATA_OUTPUT/phen_regress'
