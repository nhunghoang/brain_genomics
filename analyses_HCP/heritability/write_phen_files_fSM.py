...
out_dir = '/data1/rubinov_lab/brain_genomics/analyses_HCP/heritability/phen_files_fSM'
...
subj_file = '/data1/rubinov_lab/brain_genomics/data_HCP/schmel_filt/timeseries_order.hdf5' 
phen_file = '/data1/rubinov_lab/brain_genomics/data_HCP/schmel_filt/phenotypes/{}.hdf5'.format(phenotype)
