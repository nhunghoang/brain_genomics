...
out_dir = '/data1/rubinov_lab/brain_genomics/analyses_HCP/heritability/phen_files_HOA'
...
subj_file = '/data1/rubinov_lab/brain_genomics/data_HCP/hoacer_nofilt/timeseries_order.hdf5' 
phen_file = '/data1/rubinov_lab/brain_genomics/data_HCP/hoacer_nofilt/phenotypes/{}.hdf5'.format(phenotype)
