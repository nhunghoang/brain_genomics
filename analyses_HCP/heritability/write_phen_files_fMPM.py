...
out_dir = '/data1/rubinov_lab/brain_genomics/analyses_HCP/heritability/phen_files_fMPM'
...
## cohort with phenotypes (n = 887) 
subj_file = '/data1/rubinov_lab/brain_genomics/data_HCP/mmpmel/timeseries_order.hdf5' 
phen_file = '/data1/rubinov_lab/brain_genomics/data_HCP/mmpmel/phenotypes/{}.hdf5'.format(phenotype)
