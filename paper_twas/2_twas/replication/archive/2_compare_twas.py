'''
Compare the TWAS of interest 
against the main UKB TWAS. 
...
repl_twas = sys.argv[1] ## UKB/rand100 

## paths 
main_path = '/data1/rubinov_lab/brain_genomics'
ukbb_path = f'{main_path}/paper_twas/outputs_UKB/twas_JTI/vol_mean'
repl_path = f'{main_path}/paper_twas/outputs_{repl_twas}/twas_JTI/vol_mean'
